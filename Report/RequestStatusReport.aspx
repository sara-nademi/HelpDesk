<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMasterPage.Master"
    AutoEventWireup="true" CodeBehind="RequestStatusReport.aspx.cs" Inherits="Helpdesk.WebUI.Report.RequestStatusReport" %>
                ...
                <tr>
                    <td style="padding-right: 5px; height: 50px;" valign="middle">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px"
                            Width="30px" />&nbsp;&nbsp;<strong>گزارش وضعیت درخواست ها</strong>
                        <hr />
                    </td>
                        ...
                        <div style="direction: ltr; padding-top: 35px;">
                            <div style="width: 840px; margin: 0 auto; border: 1px groove black; margin-right: 0px;
                                ...
                                <cc1:StiWebViewer ID="requestTypeStiWebViewer" runat="server" Theme="Windows7" ToolBarBackColor="SteelBlue"
                                    RenderMode="UseCache" ViewMode="OnePage" Width="840px" Height="100%" />
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <asp:Panel ID="Panel1" runat="server" Width="280px" GroupingText="پارامترهای گزارش"
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td align="right">
                                        <telerik:RadComboBox ID="workFlowRadComboBox" runat="server" Width="200px" EmptyMessage="انتخاب کنید..." HighlightTemplatedItems="true" EnableLoadOnDemand="true" Filter="StartsWith"></telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
                                        <asp:Label ID="Label3" runat="server" Text="از تاریخ :"></asp:Label>
                                    </td>
                                    <td align="right">
                                        <%--<telerik:RadMaskedTextBox ID="fromDateRadMaskedTextBox" runat="server" Mask="<1357..3000></><1..12></><1..31>" Width="200px" Skin="Outlook"></telerik:RadMaskedTextBox>--%>
                                ...
                                <tr>
                                    <td width="30%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
                                        <asp:Label ID="Label1" runat="server" Text="تا تاریخ :"></asp:Label>
                                    </td>
                                    <td align="right">
                                        <%--<telerik:RadMaskedTextBox ID="toDateRadMaskedTextBox" runat="server" Mask="<1357..3000></><1..12></><1..31>" Width="200px" Skin="Outlook"></telerik:RadMaskedTextBox>--%>
