<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseLocation.aspx.cs" Inherits="Helpdesk.WebUI.Report.ReportPopups.ChooseLocation" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>مکان فیزیکی</title>
    <style type="text/css">
        *
        {
            font-family: Tahoma;
 ...
 <script type="text/javascript">
     ...
     function closeButton() {
         var treeView = $find("<%=TreeViewLocationRad.ClientID%>");
         ...
         if (selectedNode !=null) {
             ...
             while (currentObject != null) {
                 if (currentObject.get_parent() != null) {
                     if(currentObject.get_text() != 'محل های فیزیکی')//By MHS
                     locationHierarchicalText = currentObject.get_text() + " --> " + locationHierarchicalText;
                 }
                 currentObject = currentObject.get_parent();
             }

             closeAndReturnValues(selectedNode.get_value(), locationHierarchicalText.replace('محل های فیزیکی - ', ''));
         }
         else {
            ...
            <tr>
                ...
                <td dir="rtl" style="text-align: right;">
                    <asp:Panel ID="Panel1" runat="server" BorderColor="#333333" Font-Names="tahoma" Font-Size="10pt"
                        ForeColor="Gray" GroupingText="آدرس ها">
                        <telerik:RadTreeView ID="TreeViewLocationRad" runat="server" ExpandAnimation-Type="InBack"
                            Font-Bold="false" Font-Size="8pt" Skin="Office2007"
                            Width="360px" OnNodeExpand="TreeViewLocationRad_NodeExpand"
                           >
