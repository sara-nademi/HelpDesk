<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/AdminMasterPage.Master"
    CodeBehind="RequestByInsertUserReport.aspx.cs" Inherits="Helpdesk.WebUI.Report.RequestByInsertUserReport" %>
    ...
    <table class="Table">
        <tr>
            <td style="padding-right: 5px; height: 50px;" valign="middle">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px" Width="30px" />&nbsp;&nbsp;<strong>گزارش درخواست بر اساس کاربران نهایی</strong>
                <hr />
            </td>
            <td rowspan="2" valign="top">
                <div style="direction: ltr; padding-top: 35px;">
                    <div style="width: 840px; margin: 0 auto; border: 1px groove black; margin-right: 0px; min-height: 400px; text-align: right;">
                        <cc1:StiWebViewer ID="requestTypeStiWebViewer" runat="server" Theme="Windows7" ToolBarBackColor="SteelBlue" RenderMode="UseCache" ViewMode="OnePage" Width="840px" Height="100%" Style="text-align: right" />
                    </div>
                </div>
            </td>
        </tr>
                    ...
                    <table width="100%">
                        <tr>
                            <td width="30%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
                                <asp:Label ID="Label1" runat="server" Text="نام کاربر :"></asp:Label>
                            </td>
                            <td align="right">
                                <asp:TextBox ID="txtUserFullName" runat="server" Width="146px" lang="fa" Font-Names="Tahoma" Font-Size="9pt"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
