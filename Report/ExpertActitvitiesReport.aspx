<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/AdminMasterPage.Master"
    CodeBehind="ExpertActitvitiesReport.aspx.cs" Inherits="Helpdesk.WebUI.Report.ExpertActitvitiesReport" %>
...
<%--    <asp:UpdatePanel runat="server" ID="UpdatePanel">
        <ContentTemplate>--%>
            <table class="Table">
                <tr>
                    <td style="padding-right: 60px; height: 50px;" valign="middle">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px"
                            Width="30px" />&nbsp;&nbsp;<strong>گزارش فعالیت کارشناس</strong>
                        <hr />
                    </td>
                ...
                <tr>
                    <td width="10%" valign="top" style="text-align: left">
                        <asp:Panel ID="Panel1" runat="server" Width="300px" GroupingText="پارامترهای گزارش"
