<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMasterPage.Master"
    AutoEventWireup="true" CodeBehind="RequestPriorityReport.aspx.cs" Inherits="Helpdesk.WebUI.Report.RequestPriorityReport" %>
                ...
                <tr>
                    <td style="padding-right: 5px; height: 50px;" valign="middle">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px"
                            Width="30px" />&nbsp;&nbsp;<strong>گزارش اولویت در خواست ها</strong>
                        <hr />
                    </td>
                            ...
                            <table width="100%">
                                <tr>
                                    <td width="20%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
                                        <asp:Label ID="Label1" runat="server" Text="اولویت : "></asp:Label>
                                    </td>
                                    <td align="right">
                                        <telerik:RadComboBox ID="prirityDropDownList" runat="server" EmptyMessage="انتخاب کنید..."
                                            HighlightTemplatedItems="True" EnableLoadOnDemand="True" 
                                            Filter="StartsWith" Skin="Outlook">
                                            <Items>
                                                <telerik:RadComboBoxItem runat="server" Text="پایین" Value="10" />
                                                <telerik:RadComboBoxItem runat="server" Text="معمولی" Value="30" />
                                                <telerik:RadComboBoxItem runat="server" Text="متوسط" Value="80" />
                                                <telerik:RadComboBoxItem runat="server" Text="خیلی زیاد" Value="100" />
                                            </Items>
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
