<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="TopTenLocation.aspx.cs" Inherits="Helpdesk.WebUI.Report.TopTenLocation" %>
                ...
                <tr>
                    <td style="padding-right: 5px; height: 50px;" valign="middle">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px"
                            Width="30px" />&nbsp;&nbsp;<strong>گزارش ده مکان فیزیکی اول</strong><hr />
                    </td>
