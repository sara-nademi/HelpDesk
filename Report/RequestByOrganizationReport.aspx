<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/AdminMasterPage.Master"
    CodeBehind="RequestByOrganizationReport.aspx.cs" Inherits="Helpdesk.WebUI.Report.RequestByOrganizationReport" %>
            ...
            <table class="Table">
                <tr>
                    <td style="padding-right: 5px; height: 50px;" valign="middle">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px"
                            Width="30px" />&nbsp;&nbsp;<strong>گزارش درخواست بر اساس ساختار سازمانی</strong>
                        <hr />
                    </td>
                        ...
                        <div style="direction: ltr; padding-top: 35px;">
                            <div style="width: 840px; margin: 0 auto; border: 1px groove black; margin-right: 0px;
                                ...
                                <cc1:StiWebViewer ID="requestTypeStiWebViewer" runat="server" Theme="Windows7" ToolBarBackColor="SteelBlue"
                                    RenderMode="UseCache" ViewMode="OnePage" Width="840px" Height="100%" Style="text-align: right" />
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td width="25%" valign="top" style="text-align: left">
                        <asp:Panel ID="Panel1" runat="server" Width="280px" GroupingText="پارامترهای گزارش"
                            ...
                            <table width="100%">
                                <tr>
                                    <td width="30%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
                                        <asp:Label ID="Label1" runat="server" Text="ساختار سازمانی"></asp:Label>
                                    </td>
                                    <td align="right">
                                        <telerik:RadComboBox ID="firstOrganChartRadComboBox" runat="server" AutoPostBack="true" OnSelectedIndexChanged="firstOrganChartRadComboBox_SelectedIndexChanged" EmptyMessage="انتخاب کنید..." HighlightTemplatedItems="true" EnableLoadOnDemand="true" Filter="StartsWith" Width="190px" Style="z-index:  99999;" Skin="Outlook"></telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="right">
                                        <telerik:RadComboBox ID="secoundOrganChartRadComboBox" runat="server" EmptyMessage="انتخاب کنید..." HighlightTemplatedItems="true" EnableLoadOnDemand="true" Filter="StartsWith" Width="190px"  Style="z-index:  99999;" Skin="Outlook" AutoPostBack="true" OnSelectedIndexChanged="secoundOrganChartRadComboBox_SelectedIndexChanged"></telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%" align="left">
                                    ...
                                    <td align="right">
                                        <telerik:RadComboBox ID="thirdOrganChartRadComboBox" runat="server" AutoPostBack="true" EmptyMessage="انتخاب کنید..." HighlightTemplatedItems="true" Width="190px" Skin="Outlook" EnableLoadOnDemand="true" Filter="StartsWith"  Style="z-index:  99999;"></telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <%--<telerik:RadMaskedTextBox ID="toDateRadMaskedTextBox" runat="server" Mask="<1357..3000></><1..12></><1..31>" Width="150px" Skin="Outlook"></telerik:RadMaskedTextBox>--%>
