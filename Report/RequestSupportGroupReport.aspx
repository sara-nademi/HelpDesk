<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/AdminMasterPage.Master"
    CodeBehind="RequestSupportGroupReport.aspx.cs" Inherits="Helpdesk.WebUI.Report.RequestSupportGroupReport" %>
                ...
                <tr>
                    <td style="padding-right: 5px; height: 50px;" valign="middle">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px"
                            Width="30px" />&nbsp;&nbsp;<strong>گزارش درخواست به تفکیک گروه پشتیبانی</strong>
                        <hr />
                    </td>
                        ...
                        <asp:Panel ID="Panel1" runat="server" Width="280px" GroupingText="پارامترهای گزارش"
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td align="right">
                                         <telerik:RadComboBox ID="SupportGroupList" runat="server" EmptyMessage="انتخاب کنید..." HighlightTemplatedItems="true" EnableLoadOnDemand="true" Filter="StartsWith" Skin="Outlook"></telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%" align="left" style="background-color: #CCFFFF; border: thin solid #CCCCCC">
