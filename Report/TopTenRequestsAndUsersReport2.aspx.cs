...
{
    public partial class TopTenRequestsAndUsersReport2 : System.Web.UI.Page
    {
        protected class RequestClassData
        {
            public long ReqestTypID 
            { 
                get; 
                set; 
            }
            public long requestTypeCount 
            { 
                get; 
                set; 
            }
        ...
        protected void okRadButton_Click(object sender, EventArgs e)
        {
            ...
            string path = Server.MapPath("TopTenRequestsAndUsersReport2.mrt");
            report.Load(path);
            report.Compile();
