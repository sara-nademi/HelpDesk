<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/AdminMasterPage.Master"
    CodeBehind="TopTenRequestsAndUsersReport2.aspx.cs" Inherits="Helpdesk.WebUI.Report.TopTenRequestsAndUsersReport2" %>
            ...
            <table class="Table">
                <tr>
                    <td style="padding-right: 5px; height: 50px;" valign="middle">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/icon/report.png" Height="30px"
                            Width="30px" />&nbsp;&nbsp;<strong>گزارش ده خرابی اول و ده کاربر اول (شماره دو)</strong>
                        <hr />
                    </td>
                ...
                <tr>
                    <td width="10%" valign="top" style="text-align: left">
                        <asp:Panel ID="Panel1" runat="server" Width="250px" GroupingText="پارامترها"
